...
public class ViewAllActivity extends AppCompatActivity {
    ...
    private List<ViewAllModel> createSampleData() {
        ...
        itemList.add(new ViewAllModel("MINERAL MIXTURE", "Unlock the potential of your livestock with our premium Mineral Mixture, a vital blend enriched with essential nutrients for optimal health and vitality.", "4.9", R.drawable.product3));
